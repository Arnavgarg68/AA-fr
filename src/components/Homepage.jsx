    ...
    <div className='homepage-main-body'>
      <div className="homepage-main-inner-body">
        ...
        <div className="homepage-contentbox">
            <img src={nasya} alt="nasya image" data-aos="zoom-in" data-aos-duration="2000"/>
        ...
        <div className="homepage-contentbox">
            <img src={janu} alt="nasya image" data-aos="zoom-in" data-aos-duration="2000"/>
            <div className="homepage-content-text" data-aos="zoom-in" data-aos-duration="2000">
        ...
        <div className="homepage-contentbox">
            <img src={abhyanga} alt="nasya image" data-aos="zoom-in" data-aos-duration="2000"/>
            <div className="homepage-content-text" data-aos="zoom-in" data-aos-duration="2000">
        ...
        <div className="homepage-contentbox">
            <img src={patrapindaswedana} alt="nasya image" data-aos="zoom-in" data-aos-duration="2000"/>
            <div className="homepage-content-text" data-aos="zoom-in" data-aos-duration="2000">
        ...
        <div className="homepage-contentbox">
            <img src={katibasti} alt="nasya image" data-aos="zoom-in" data-aos-duration="2000"/>
            <div className="homepage-content-text" data-aos="zoom-in" data-aos-duration="2000">
        ...
        <div className="homepage-contentbox">
            <img src={swedanatherapy} alt="nasya image" data-aos="zoom-in" data-aos-duration="2000"/>
            <div className="homepage-content-text" data-aos="zoom-in" data-aos-duration="2000">
        ...
        <div className="homepage-contentbox">
            <img src={animabasti} alt="nasya image" data-aos="zoom-in" data-aos-duration="2000"/>
            <div className="homepage-content-text" data-aos="zoom-in" data-aos-duration="2000">
